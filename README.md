...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=majestyyyy&color=8b5cf6&style=flat-square&label=Profile+Views" alt="Profile Views" />
</p>
...
| :--- | :--- | :--- | :---: |
| **Centimo** | Student financial platform with multi-wallet tracking, dynamic budget reallocation, and BNPL management | `Flutter` `React Native` `Next.js` `Supabase` | [Visit](https://centimov1.vercel.app/) |
| **DigiKaha** | Multi-tenant Point of Sale (POS) system unifying inventory, staff, branch ops, and transactions | `Next.js` `React` `TypeScript` `Tailwind CSS` | [Visit](https://digikaha.vercel.app/) |
| **AI Reviewers** | Bachelor's Thesis: AI-powered study guide and quiz generator validated with 200+ students | `React` `TypeScript` `Node.js` `AI` | [Visit](https://ai-gir-v2.vercel.app/) |
| **Student Welfare System** | Campus support initiative platform streamlining student services & welfare assistance | `UI/UX` `React` `Web Development` | [Visit](https://ue-usc-mnl.vercel.app/) |
...
<p>
  ...
  <img src="https://img.shields.io/badge/Bruno-F0DB4F?style=for-the-badge&logo=postman&logoColor=black" />
